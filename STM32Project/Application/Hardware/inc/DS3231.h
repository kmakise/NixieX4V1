...
#define SCL_H() HAL_GPIO_WritePin( DS3231_SCL_GPIO_Port,DS3231_SCL_Pin,GPIO_PIN_SET)
#define SCL_L() HAL_GPIO_WritePin(DS3231_SCL_GPIO_Port,DS3231_SCL_Pin,GPIO_PIN_RESET)

#define SDA_H() HAL_GPIO_WritePin(DS3231_SDA_GPIO_Port,DS3231_SDA_Pin,GPIO_PIN_SET)
#define SDA_L() HAL_GPIO_WritePin(DS3231_SDA_GPIO_Port,DS3231_SDA_Pin,GPIO_PIN_RESET)

#define IN_SDA() HAL_GPIO_ReadPin(DS3231_SDA_GPIO_Port,DS3231_SDA_Pin)

//#define SCL_H() DS3231_SCL_GPIO_Port->BSRR = DS3231_SCL_Pin
//#define SCL_L() DS3231_SCL_GPIO_Port->BRR = DS3231_SCL_Pin

//#define SDA_H() DS3231_SDA_GPIO_Port->BSRR = DS3231_SDA_Pin
//#define SDA_L() DS3231_SDA_GPIO_Port->BRR = DS3231_SDA_Pin

//#define IN_SDA() (((DS3231_SDA_GPIO_Port->IDR & DS3231_SDA_Pin) != (uint32_t)GPIO_PIN_RESET))
